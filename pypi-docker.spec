...
Source0  : https://files.pythonhosted.org/packages/91/9b/4a2ea29aeba62471211598dac5d96825bb49348fa07e906ea930394a83ce/docker-7.1.0.tar.gz
...
%prep
%setup -q -n docker-7.1.0
cd %{_builddir}/docker-7.1.0
pushd ..
cp -a docker-7.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716479824
